                ...
                <div className="container mx-auto">
                    ...
                    <div className='flex flex-wrap justify-center gap-8'>
                        ...
                        <div className="backdrop-blur-sm p-8 rounded-xl border border-purple-500/30 hover:border-purple-500 transition-all duration-300 w-80 text-center">
                                ...
                                <p className="text-gray-300 mb-4">B.Tech IIT Jodhpur</p>
                                <p className="text-gray-300 mb-6">Founder</p>
                                {/* Social Media Icons */}
                        ...
                        <div className="backdrop-blur-sm p-8 rounded-xl border border-purple-500/30 hover:border-purple-500 transition-all duration-300 w-80 text-center">
                                ...
                                <div className="w-32 h-32 bg-purple-600 rounded-full flex items-center justify-center mx-auto mb-6">
                                    <img
                                        src={team_member02} 
                                        alt="Raghav Vijayvergia"
                                        className="w-full h-full rounded-full object-cover"
                                    />
                                </div>
                                <h3 className="text-2xl font-semibold mb-3">Raghav Vijayvergia</h3>
                                <p className="text-gray-300 mb-4">B.Tech IIT Jodhpur</p>
                                <p className="text-gray-300 mb-6">Co-Founder</p>
                                {/* Social Media Icons */}
                                <div className="flex justify-center space-x-4">
                                    <a href="#" className="text-purple-400 hover:text-purple-300">
                                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
